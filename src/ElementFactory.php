...
class ElementFactory {
	...
	static function a( IParent $i_par, ?string $i_nstHref = null,
	...
	static function aside( IParent $i_par,
	...
	static function br( IParent $i_par ) : Elements\Br {
	...
	static function footer( IParent $i_par,
	...
	static function form( IParent $i_par, ?string $i_nstAction = null,
	...
	static function li( IParent $i_par, ... $i_rxChildren ) : Elements\Li {
		require_once __DIR__ . '/Elements/Li.php';
		return new Elements\Li( $i_par, ... $i_rxChildren );
	}


	static function link( IParent $i_par, ?string $i_nstHref = null,
