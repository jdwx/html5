 ...
 * @covers \JDWX\HTML5\HtmlElement
 */
final class HtmlElementTest extends MyTestCase {
    ...
    */
    ...
    public function testGetElementById() : void {
        ...
        $el = new HtmlElement();
        $el1 = HtmlElement::synthetic( 'child' );
        $el1->id( 'el1' );
        $el2 = new HtmlElement();
        $el2->id( 'el2' );
        $el3 = HtmlElement::synthetic( 'child' );
        $el3->id( 'el3' );
        $el4 = HtmlElement::synthetic( 'child' );
        $el4->id( 'el4' );
    ...
    */
    ...
    public function testToString() : void {
        ...
        $el2 = HtmlElement::synthetic( 'el2' );
        $el3 = ( new HtmlElement() )->id( 'el3' );
        $el->append( $el2, $el3 );
